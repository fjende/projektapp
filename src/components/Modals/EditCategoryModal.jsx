    ...
    return (
      <div className={classes.modal}>
        <Formik
          ...
          initialValues={{ dateFrom: currentCategory.timeFrom, dateTo: currentCategory.timeTo }}
          render={formikProps => {
            return (
                ...
                <Form className={classes.form}>
                  <div className={classes.inputs}>
                    <KeyboardTimePicker
                      ...
                      minutesStep={5}
                      onChange={dateFrom => {
                        formikProps.setFieldValue('timeFrom', dateFrom);
                      }}
                    />
                    <KeyboardTimePicker
                      ampm={false}
                      ...
                      onChange={dateTo => formikProps.setFieldValue('timeTo', dateTo)}
                    />
